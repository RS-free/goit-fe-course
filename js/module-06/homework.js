...
class Hamburger {
  ...
  calculatePrice() {
    ...
    let toppingPrice = this._toppings.reduce(
  ...
  calculateCalories() {
    ...
    let stuffingCaloies = Hamburger.STUFFINGS[this._stuffing].calories;
    //console.log(stuffingCaloies);

    let toppingCalories = this._toppings.reduce(
      (acc, el) => acc + Hamburger.TOPPINGS[el].calories,
      0
    );
    //console.log(toppingCalories);

    let totalCalories = sizeCalories + stuffingCaloies + toppingCalories;
...
Hamburger.SIZE_LARGE = "SIZE LARGE";

...
// let name = 'Генератор защитного кода ';
// let price = 1000;
// price = 2000;
...
//  }
 ...
 //==================== task 03 ======================
/*Задача. В переменной min лежит число от 0 до 59. Определите в какую четверть часа попадает это число 
...
*/ 
// const a = Number(prompt('Введите произвольное целое число'));
